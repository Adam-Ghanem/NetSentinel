...
14. **Metrics** — delivered foundation: sanitized process-local suppression and stateful-detector pressure snapshots. Remaining work: authenticated export, ingestion rate, parse failures, alert counts, rule latency, enrichment latency, and queue/backpressure signals.
